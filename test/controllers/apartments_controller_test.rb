...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { address: @apartment.address, amenities: @apartment.amenities, code: @apartment.code, cost: @apartment.cost, room: @apartment.room, state_id: @apartment.state_id }
    end
  ...
  test "should update apartment" do
    patch :update, id: @apartment, apartment: { address: @apartment.address, amenities: @apartment.amenities, code: @apartment.code, cost: @apartment.cost, room: @apartment.room, state_id: @apartment.state_id }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
