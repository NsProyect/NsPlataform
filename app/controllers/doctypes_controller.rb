class DoctypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @doctype.save
        format.html { redirect_to @doctype, notice: 'Tipo de Documento Creado.' }
  ...
  def update
    respond_to do |format|
      if @doctype.update(doctype_params)
        format.html { redirect_to @doctype, notice: 'Tipo de Documento Actualizado.' }
  ...
  def destroy
    @doctype.destroy
    respond_to do |format|
      format.html { redirect_to doctypes_url, notice: 'Tipo de Documento Eliminado.' }
  ...
  private
    ...
    def doctype_params
      params.require(:doctype).permit(:name, :abbrev)
    end
end
