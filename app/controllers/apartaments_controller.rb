class ApartamentsController < ApplicationController
  ...
  def index
    @apartaments = Apartament.search(params[:search], params[:page])
  end
  ...
  def create
    ...
    respond_to do |format|
      if @apartament.save
        format.html { redirect_to @apartament, notice: 'Apartamento Creado Satisfactoriamente.' }
  ...
  def update
    respond_to do |format|
      if @apartament.update(apartament_params)
        format.html { redirect_to @apartament, notice: 'Apartamento Modificado Satisfactoriamente.' }
  ...
  def destroy
    @apartament.destroy
    respond_to do |format|
      format.html { redirect_to apartaments_url, notice: 'Apartamento Destruido Satisfactoriamente.' }
  ...
  private
    ...
    def apartament_params
      params.require(:apartament).permit(:adress, :states_id, :room, :cost, :amenities)
    end
end
